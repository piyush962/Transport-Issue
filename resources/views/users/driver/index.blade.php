<x-app-layout>
    <div class="flex flex-wrap items-center mb-2.5 ">
        <div class="w-full md:w-6/12 ">
            <h3 class="text-[#1E1E1E] font-medium text-lg tracking-[-0.04em] py-3">Driver</h3>
        </div>
        <div class="w-full md:w-6/12">
            ...
            <table class="min-w-full">
                <thead>
                    <tr class="bg-[rgba(255,59,48,0.1)]">
                        <td class="px-3 lg:px-4 py-3 whitespace-nowrap lg:py-4 text-sm font-medium text-[#1E1E1E]  text-left uppercase tracking-[-0.04em]">Name</td>
                        <td class=" px-3 lg:px-4 py-3 whitespace-nowrap lg:py-4  text-sm font-medium text-[#1E1E1E]  text-left uppercase tracking-[-0.04em]">Phone No.</td>
                        <td class="px-3 lg:px-4 py-3 whitespace-nowrap lg:py-4   text-sm font-medium text-[#1E1E1E]  text-left uppercase tracking-[-0.04em]">Email</td>
                        <td class="px-3 lg:px-4 py-3 whitespace-nowrap lg:py-4   text-sm font-medium text-[#1E1E1E]  text-left uppercase tracking-[-0.04em]">License No.</td>
                        ...
                        <td class="px-3 lg:px-4 py-3 whitespace-nowrap lg:py-4   text-sm font-medium text-[#1E1E1E]  text-left uppercase tracking-[-0.04em]  w-[110px]">Availability status</td>
                    </tr>
                </thead>
                <tbody>
                    <tr class="bg-white border-t transition duration-300 ease-in-out hover:bg-gray-100">
                        ...
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] font-medium text-[#1E1E1E] tracking-[-0.04em]">+91 9934556720</td>
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] font-medium text-[#1E1E1E] tracking-[-0.04em]">Rakesh@gmail.com</td>
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] whitespace-nowrap font-medium text-[#1E1E1E] tracking-[-0.04em]">DL-0456-RJ</td>
                        ...
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] font-medium text-[#1E1E1E] tracking-[-0.04em]">
                            <label class="bg-[rgba(76,175,80,0.1)] text-[#4CAF50] rounded-[10px] min-w-[50px] text-[15px] fonte-medium tracking-[-0.04em] py-2 px-2 text-center inline-block">Yes</label>
                        </td>
                    ...
                    <tr class="bg-white border-t transition duration-300 ease-in-out hover:bg-gray-100">
                        ...
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] font-medium text-[#1E1E1E] tracking-[-0.04em]">RJ2065</td>
                        <td class=" px-3 lg:px-4 py-3 lg:py-4 text-[15px] font-medium text-[#1E1E1E] tracking-[-0.04em]">
                            <label class="bg-[rgba(255,59,48,0.1)] text-[#FF3B30] rounded-[10px] min-w-[50px] text-[15px] fonte-medium tracking-[-0.04em] py-2 px-2 text-center inline-block">No</label>
                        </td>
